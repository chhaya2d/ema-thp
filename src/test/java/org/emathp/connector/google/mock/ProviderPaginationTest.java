...
class ProviderPaginationTest {
    ...
    void mockNotionCursorProgression_eofNull() {
        ...
        var p1 = api.search(new NotionSearchRequest(null, null, 4));
        assertEquals("cursor_4", p1.nextCursor());
        var p2 = api.search(new NotionSearchRequest(null, p1.nextCursor(), 4));
