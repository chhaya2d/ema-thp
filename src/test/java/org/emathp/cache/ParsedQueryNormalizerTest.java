...
class ParsedQueryNormalizerTest {
    ...
    void selectListIdentifierCasingNormalizes() {
        Query q1 = new Query(List.of("g.Title"), null, List.of(), 3, null, null);
        Query q2 = new Query(List.of("g.title"), null, List.of(), 3, null, null);
        assertEquals(ParsedQueryNormalizer.canonical(q1), ParsedQueryNormalizer.canonical(q2));
    }

    @Test
    void limitDistinguishesKeys() {
        Query q1 = new Query(List.of(), null, List.of(), 3, null, null);
        Query q2 = new Query(List.of(), null, List.of(), 4, null, null);
    ...
    void cacheKeyCombinesScopeProfileAndBody() {
        String canon = ParsedQueryNormalizer.canonical(new Query(List.of("a"), null, List.of(), 1, null, null));
        QueryCacheScope s1 = new QueryCacheScope("u1", 1);
        QueryCacheScope s2 = new QueryCacheScope("u2", 1);
